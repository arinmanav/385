...
module pacman_mm_interconnect_0_router_default_decode
  #(
...
module pacman_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    pacman_mm_interconnect_0_router_default_decode the_default_decode(
